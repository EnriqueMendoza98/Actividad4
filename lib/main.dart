          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10,),
                Text("¡Descubre lo que se está cocinando hoy!", style: TextStyle(
                  color: Colors.grey,
                  fontSize: 15,
                ),),
                SizedBox(height: 15,),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10,),
                            Text("Comida desde otra parte del mundo", style: TextStyle(
                              color: Colors.white,
                              fontSize: 13
                            ),)
                          ],
                ...
                Row(
                  ...
                  children: [
                    Text("Lugares Recomendados", style: TextStyle(
                      fontSize: 22,
                      fontWeight: FontWeight.w700
                    ),),
                    SizedBox(width: 10,),
