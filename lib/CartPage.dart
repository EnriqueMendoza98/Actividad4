              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 15,),
                    Text("Platillo perfecto, de una región del mundo historica", style: TextStyle(
                        color: Colors.white,
                        fontSize: 12
                    ),)
                  ],
                ...
                child: Column(
                  children: [
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        Text("Tu Carrito", style: TextStyle(
                            fontSize: 22,
                            fontWeight: FontWeight.w700
                        ),),
                        SizedBox(width: 10,),
                    ...
                    SizedBox(height: 25,),
                    Text("Tienes un código de promoción?", style: TextStyle(
                      color: blue
                    ),),
                    SizedBox(height: 20,),
                    InkWell(
